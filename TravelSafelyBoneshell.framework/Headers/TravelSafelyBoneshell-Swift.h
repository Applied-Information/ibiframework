...
#ifndef TRAVELSAFELYBONESHELL_SWIFT_H
#define TRAVELSAFELYBONESHELL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TravelSafelyBoneshell",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC21TravelSafelyBoneshell8APIClass")
...
SWIFT_CLASS("_TtC21TravelSafelyBoneshell12AlarmsHelper")
@interface AlarmsHelper : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21TravelSafelyBoneshell20AppSingletonVariable")
@interface AppSingletonVariable : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21TravelSafelyBoneshell9AuthClass")
...
SWIFT_CLASS("_TtC21TravelSafelyBoneshell26AutoDetectVehicleAlgorithm")
...
SWIFT_CLASS("_TtC21TravelSafelyBoneshell6Helper")
